...
class ASN1Object {
  ...
  Uint8List? value;
  ASN1Object(this.tag);
  ASN1Object.fromBytes(Uint8List bytes) : tag = bytes[0], value = bytes.sublist(2); // Simplified (Assumes < 128 byte simple headers for OIDs)
...
// Fixed length encoding for large payloads (e.g. 2048 bit keys)
